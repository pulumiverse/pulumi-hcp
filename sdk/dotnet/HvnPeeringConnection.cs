...
namespace Pulumi.Hcp
{
    ...
    ///     public MyStack()
    ///     {
    ///         var hvn1 = new Hcp.Hvn("hvn1", new Hcp.HvnArgs
    ///         {
    ///             HvnId = "hvn-1",
    ///             CloudProvider = "aws",
    ///             Region = "us-west-2",
    ...
    ///         });
    ///         var hvn2 = new Hcp.Hvn("hvn2", new Hcp.HvnArgs
    ///         {
    ///             HvnId = "hvn-2",
    ///             CloudProvider = "aws",
    ///             Region = "us-west-2",
    ...
    ///         });
    ///         var peer1 = new Hcp.HvnPeeringConnection("peer1", new Hcp.HvnPeeringConnectionArgs
    ///         {
    ///             Hvn1 = hvn1.SelfLink,
    ///             Hvn2 = hvn2.SelfLink,
    ///         });
    ...
    public partial class HvnPeeringConnection : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class HvnPeeringConnectionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique URL of one of the HVNs being peered.
        /// </summary>
    ...
    public sealed class HvnPeeringConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The time that the peering connection was created.
        /// </summary>
