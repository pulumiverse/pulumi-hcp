...
namespace Pulumi.Hcp
{
    public static class GetConsulAgentKubernetesSecret
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var test = Output.Create(Hcp.GetConsulAgentKubernetesSecret.InvokeAsync(new Hcp.GetConsulAgentKubernetesSecretArgs
        ///         {
    ...
    public sealed class GetConsulAgentKubernetesSecretArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetConsulAgentKubernetesSecretInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The ID of the HCP Consul cluster.
        /// </summary>
