...
namespace Pulumi.Hcp
{
    static class Utilities
    {
        ...
        public static InvokeOptions WithDefaults(this InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/grapl-security/pulumi-hcp/releases/download/${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Hcp.version.txt");
    ...
    internal sealed class HcpResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public HcpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
